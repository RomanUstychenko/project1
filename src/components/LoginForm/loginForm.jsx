...
export default function LoginForm({ onSubmit }) {
  ...
  return (
    <FormLogin onSubmit={handleSubmit}>
      <LoginFormWrapper>
        <LoginFormList>
          <LoginFormLabel htmlFor={emailId}>Login</LoginFormLabel>
          <LogRegInput
            id={emailId}
        ...
        <LoginFormList>
          <LoginFormLabel htmlFor={passwordId}>Password</LoginFormLabel>
          <LogRegInput
            id={passwordId}
      ...
      <ButtonLogReg type="submit">
        <TextButton>Login {isLoadingUser && <Loader />}</TextButton>
      </ButtonLogReg>
    </FormLogin>
  );
}
